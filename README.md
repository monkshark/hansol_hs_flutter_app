...
| 지표 | 수치 | 비고 |
|------|------|------|
| **총 코드 라인** | **약 51,900** | Dart 44,349 + TypeScript/TSX 3,057 + JS 2,940 + Java/XML 1,174 + Swift 373 |
| **소스 파일** | **193개** (Flutter) + **30개** (Admin Web TS/TSX) + Android/iOS 위젯 | screens, 추출 위젯, models/utils/services |
